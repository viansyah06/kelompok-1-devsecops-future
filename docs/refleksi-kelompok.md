...
|:--------|:-----------------|
| [Nama] | Paper reading (SBOM & Vendor Affinity), Gap Analysis, State-of-the-Art |
| [Nama] | Design Decisions, Implementasi pipeline (GitHub Actions, Dockerfile) |
| [Nama] | Evaluasi & Analisis, Refleksi, README |
| [Nama] | Presentasi slides, koordinasi review |
